...
<div class="ui-middle-screen">
	<div class="content-workorder">
		...
		<?php if($this->input->get('wo')!=''){?>
		<br>
		<input  type="button" onclick="location.href='<?php echo base_url();?>index.php/contentcontroller/technicalsummary?wrk_ord=<?=$this->input->get('wo')?>&wo=3'"class="btn-button btn-primary-button" name="back" value="Back To WorkOrder" style="width:200px;" />
		<br>
		<br>
		<?php } ?>
			...
			<div class="n-req">MRIN number will be automatically generated by the system.<span style="color:red;"><?php echo validation_errors(); ?></span></div>
							...
							<tr >
								<td class="ui-desk-style-table">
									<table class="ui-content-form" width="100%" border="0">
										...
										<tr>
											<td style="padding-left:10px;" valign="top">Contract : <input type="checkbox" id="contract" name="contract" value="yes" <?php if($this->input->get('pro') == 'edit'){if($record[0]->ContractStatus != null) echo 'checked';} ?>> Yes  </td>
											<td class="yes" style="padding-left:10px; <?php if($this->input->get('pro') == 'new'){echo 'display:none' ;}else{if($record[0]->ContractStatus == null) echo 'display:none';}?>" valign="top">
