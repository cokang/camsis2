...
<div style='text-align: center'>Budget Status As At <text style="color:blue;"><?php echo date('d M Y'); ?></text></div>
                ...
                <td id='budget-width'><div style='background-color:white;' id="log0">RM<?= $OPU?>  </div></td>
                <td id='budget-width'>Budget Balance </td>
                <td id='budget-width'><div style='background-color:white;' id="log2">RM <?=$max_opu-$OPU?> </div></td>
                <th class="vl" >APMIS (CHO)</th>
                <td  id='budget-width'>Budget Spent </td>
                <td id='budget-width'><div style='background-color:white;' id="log1">RM <?= $CHO?>  </div></td>
                <td id='budget-width'>Budget Balance </td>
                <td id='budget-width'><div style='background-color:white;' id="log3">RM <?=$max_cho-$CHO?> </div></td>
            <!-- </tr>
                <tr><td width='20%'>
