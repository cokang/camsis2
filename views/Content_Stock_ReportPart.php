	...
	<div class="content-workorder" align="center">
		...
		<!-- <?php if (!in_array("contentcontroller/Attendance", $chkers)) { ?> -->
			<tr class="<?php  $number++; echo evenodd($number); ?> ">
				<td colspan="4">
					<?php echo anchor ('contentcontroller/Report_part','<img src="'. base_url() .'images/user.png" alt="" class="ui-icon"/>&nbsp;&nbsp;&nbsp;&nbsp;Stock Report'); ?>
				</td>
			</tr>
		    <!-- <?php  } ?> -->
		    <!-- <?php if (!in_array("contentcontroller/Attendance", $chkers)) { ?> -->
			<tr class="<?php  $number++; echo evenodd($number); ?>">
				<td colspan="4">
					<?php echo anchor ('contentcontroller/store_report','<img src="'. base_url() .'images/user.png" alt="" class="ui-icon"/>&nbsp;&nbsp;&nbsp;&nbsp;Store Report'); ?>
				</td>
			</tr>
		    <!-- <?php  } ?>  -->
</table>
