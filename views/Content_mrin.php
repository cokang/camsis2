...
<?php (($this->session->userdata('hosp_code')=='HSI' || $this->session->userdata('hosp_code')=='HSA' ||  $this->session->userdata('hosp_code')=='MUR') && $user[0]->class_id=='27')?$disableMrin='onclick="return false"' : $disableMrin='' ?>
<div class="ui-middle-screen">
	...
	<div class="content-workorder">
		<table class="ui-content-middle-menu-workorder" border="0" height="" align="center">
			...
			<tr style="display:none;" id="myElem" class="onloadworkorder">
				<th colspan="4" style="text-align:left; color:#ee4000;">Mrin have been registered.&nbsp;&nbsp;<span class="blinking"><font color="black">; </font><?=$this->input->get('mrin')?></span></th>
			</tr>
...
<script>
var mrin = '<?=($this->input->get('mrin')) ? $this->input->get('mrin') : '';?>';
