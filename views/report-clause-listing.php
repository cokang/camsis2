	...
	<?php } ?>
		<div class="m-div">
			...
			<table class="rport-header">
				<tr>
					<td colspan="5">
						Clause Summary All Hospital - <?=date('F', mktime(0, 0, 0, $month, 10))?> <?=$year?> - <?php echo $this->session->userdata('usersessn');?> ( <?php if ($this->input->get('grp') == ''){echo 'ALL'; }else{ echo 'Group '.$this->input->get('grp');} ?> )
					</td>
				</tr>
			</table>
...
<td> 
	<ul>
	<li>Total Clause 0</li>
	<li>Total Open 0</li>
	<li>Total Closed 0</li>
	</ul>	
</td>
</tr>
...
<td> 
	<ul>
	<!--<li>Total 8.2 Clause 0</li>
	<li>Total 21.2 Clause 0</li>
	<li>Total 21.3 Clause 0</li>-->
	<li>Total Clause 0</li>
	</ul>	
</td>
</tr>
...
<td> 
	<ul>
	<li>Total 12 (8.2) Clause 0</li>
	<li>Total 44.1 (21.2) Clause 0</li>
	<li>Total 44.2 (21.3) Clause 0</li>
	<li>Total Clause 0</li>
	</ul>	
</td>
</tr>
