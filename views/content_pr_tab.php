<tr class="ui-left_web">
	...
	<?php echo anchor ('Procurement/e_pr?tab=0'.'&from='.$from.'&to='.$to, 'PR Approval'); ?></td>
	...
	<?php echo anchor ('Procurement/e_pr?tab=1'.'&from='.$from.'&to='.$to, 'PO Approval'); ?></td> 
	...
	<?php echo anchor ('Procurement/e_pr?tab=2'.'&from='.$from.'&to='.$to, 'PO Approved'); ?></td>
</tr>
