<tr class="ui-left_web">
	...
	<?php echo anchor ('Procurement/e_request?tab=0'.'&from='.$from.'&to='.$to, 'PO Listing'); ?></td>
	...
	<?php echo anchor ('Procurement/e_request?tab=1'.'&from='.$from.'&to='.$to, 'Payment Process'); ?></td>
