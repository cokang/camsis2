...
<div class="ui-middle-screen">
	<div class="content-workorder">
		...
		<div class="ui-main-form">
			...
			<div class="n-req">Please key in asset number as per ASIS asset number<!--Asset number will be automatically generated by the system.--><br> <span style="color:red;"><?php echo validation_errors(); ?></span></div>
							...
							<td class="ui-desk-style-table">
								<table class="ui-content-form" width="100%" border="0">
									...
									<tr>
										...
										<td style="padding-left:10px;" valign="top"><input type="text" id="n_tag_no" name="n_tag_no" value="<?php echo set_value('n_tag_no'); ?>" class="form-control-button"></td>
									</tr>
									<tr>
