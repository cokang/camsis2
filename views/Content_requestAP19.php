...
<div class="ui-middle-screen">
	<div class="content-workorder">
		...
		<div class="ui-main-form">
			...
			<div class="n-req">Request number will be automatically generated by the system. (*) This is mandatory fields<br> <span style="color:red;"><?php echo validation_errors(); ?></span></div>
						...
						<tr class="ui-color-contents-style-1" height="30px">
				            ...
				            <td style="padding-left:10px;" valign="top">
		              			...
		              			<?php echo form_dropdown('n_min', $min_list, set_value('n_min',($pieces) ? $pieces[1] : date('i')) , 'class="dropdown" style="width: 52px;"'); ?>
										...
										<tr>
											<td style="padding-left:10px;" valign="top">Failure Report :<text style='color:red;'>*</text> </td>
			...
			<?php
			//$pieces2 = isset($record[0]->V_User_dept_code) ? $record[0]->V_User_dept_code : 'fUserDeptCode';
			$team_list = array(
								'DES' => 'DES',
								'MLES' => 'MLES',
								'CLSES' => 'CLSES',
			...
			<div class="ui-main-form-2">
							...
							<td class="ui-desk-style-table">
								...
								?>
									...
									<tr>
										...
										<td style="padding-left:10px;" ><?php echo form_dropdown('fUserDeptCode', $team_list, set_value('fUserDeptCode',($fUserDeptCode) ? $fUserDeptCode : set_value('fUserDeptCode')) , 'class="dropdown" '); ?><!--<input type="text" name="fUserDeptCode" value="<?=isset($record[0]->V_User_dept_code) ? $record[0]->V_User_dept_code : set_value('fUserDeptCode'); ?>" class="form-control-button n_wi-date2">--></td>
									</tr>
									<tr>
								...
								<td class="ui-desk-style-table">
									...
									?>
										<tr>
											...
											<td style="padding-left:10px;" ><input type="text" name="fitem" value="<?=isset($record[0]->V_MohDesg) ? $record[0]->V_MohDesg : set_value('fitem'); ?>" class="form-control-button n_wi-date2"></td>
										</tr>
										<tr>
											<td style="padding-left:10px;" class="ui-w">Part Price (RM) : </td>
											<td style="padding-left:10px;" ><input type="text" name="fpartprice" value="<?=isset($record[0]->v_ref_status) ? $record[0]->v_ref_status : set_value('fpartprice'); ?>" class="form-control-button n_wi-date2"></td>
										</tr>
										<tr>
											<td style="padding-left:10px;" class="ui-w">Vendor Price (RM) : </td>
											<td style="padding-left:10px;" ><input type="text" name="fvendorprice" value="<?=isset($record[0]->takenby) ? $record[0]->takenby : set_value('fvendorprice'); ?>" class="form-control-button n_wi-date2"></td>
										</tr>
									</table>
								</td>
							</tr>
				...
				<div class="middle_d">
					<table class="ui-content-form-reg" style="">
						<tr class="ui-color-contents-style-1" height="30px">
							<td colspan="2" class="ui-header-new"><b>Related WO/PPM<text style='color:red;'>*</text></b></td>
						</tr>
						<tr >
