							...
							<td class="ui-desk-style-table">
								<table class="ui-content-form" width="100%" border="0">
									...
									<tr>
										...
										<td style="padding-left:10px;" valign="top"><input type="text" name="n_tag_no" value="<?php echo $this->input->post('n_tag_no');?>" class="form-control-button" style="width: 83%" disabled></td>
									</tr>
									<tr>
...
<?php echo form_hidden('n_tag_no',$this->input->post('n_tag_no'));?>
