...
if ($this->input->get('ex') == ''){
	...
	<div id="Instruction" class="pr-printer">
		<div class="header-pr">B4 Summary</div>
		...
		<div class="m-div">
			...
			<table class="tftable" border="1" style="text-align:center;">
				<tr>
					...
					<th rowspan=2>Type Description</th>
					<th rowspan=2>Asset Purchase cost</th>
					<th rowspan=2>Asset Age</th>
					<th rowspan=2>TRKPI %</th>
					<th colspan=12>Uptime %</th>
					<th rowspan=2>Deduction Value per asset (RM)</th>
					<th colspan=2>Previous Deduction (Month)</th>
					<th colspan=2>Deduction for the month (Y/N)</th>
					<th colspan=2>Deduction (RM)</th>
