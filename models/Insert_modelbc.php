...
function udca_exist($value1,$job,$value2,$shift,$value3,$dept,$value4,$loc,$colorcode,$value5,$monthyear,$value6,$hosp,$value7,$jobdate){
			...
			if($query->num_rows()>0){
				...
				$this->load->model('get_model');
				$data['location'] = $this->get_model->get_poploclistax($dept);
				foreach ($data['location'] as $row){
					$this->insert_model->jic_exist('Job_Items','Floor','Dept_Code',$dept,'Loc_Code',$row->V_location_code,'3','Month_Year',$monthyear,'Job_Date',date("Y-m-d",strtotime(substr($monthyear,2,4).'-'.substr($monthyear,0,2).'-10')),'ji_no','JI/'.$dept.'/W1/'.substr($monthyear,0,2).'/'.substr($monthyear,4,2),'X');
					$this->insert_model->jic_exist('Job_Items','Wall Door','Dept_Code',$dept,'Loc_Code',$row->V_location_code,'3','Month_Year',$monthyear,'Job_Date',date("Y-m-d",strtotime(substr($monthyear,2,4).'-'.substr($monthyear,0,2).'-10')),'ji_no','JI/'.$dept.'/W1/'.substr($monthyear,0,2).'/'.substr($monthyear,4,2),'X');
					$this->insert_model->jic_exist('Job_Items','Ceiling','Dept_Code',$dept,'Loc_Code',$row->V_location_code,'3','Month_Year',$monthyear,'Job_Date',date("Y-m-d",strtotime(substr($monthyear,2,4).'-'.substr($monthyear,0,2).'-10')),'ji_no','JI/'.$dept.'/W1/'.substr($monthyear,0,2).'/'.substr($monthyear,4,2),'X');
					$this->insert_model->jic_exist('Job_Items','Windows','Dept_Code',$dept,'Loc_Code',$row->V_location_code,'3','Month_Year',$monthyear,'Job_Date',date("Y-m-d",strtotime(substr($monthyear,2,4).'-'.substr($monthyear,0,2).'-10')),'ji_no','JI/'.$dept.'/W1/'.substr($monthyear,0,2).'/'.substr($monthyear,4,2),'X');
					$this->insert_model->jic_exist('Job_Items','Fixtures','Dept_Code',$dept,'Loc_Code',$row->V_location_code,'3','Month_Year',$monthyear,'Job_Date',date("Y-m-d",strtotime(substr($monthyear,2,4).'-'.substr($monthyear,0,2).'-10')),'ji_no','JI/'.$dept.'/W1/'.substr($monthyear,0,2).'/'.substr($monthyear,4,2),'X');
					$this->insert_model->jic_exist('Job_Items','Furniture Fitting','Dept_Code',$dept,'Loc_Code',$row->V_location_code,'3','Month_Year',$monthyear,'Job_Date',date("Y-m-d",strtotime(substr($monthyear,2,4).'-'.substr($monthyear,0,2).'-10')),'ji_no','JI/'.$dept.'/W1/'.substr($monthyear,0,2).'/'.substr($monthyear,4,2),'X');
					
					$this->insert_model->jic_exist('Job_Items','Floor','Dept_Code',$dept,'Loc_Code',$row->V_location_code,'3','Month_Year',$monthyear,'Job_Date',date("Y-m-d",strtotime(substr($monthyear,2,4).'-'.substr($monthyear,0,2).'-20')),'ji_no','JI/'.$dept.'/W3/'.substr($monthyear,0,2).'/'.substr($monthyear,4,2),'X');
					$this->insert_model->jic_exist('Job_Items','Wall Door','Dept_Code',$dept,'Loc_Code',$row->V_location_code,'3','Month_Year',$monthyear,'Job_Date',date("Y-m-d",strtotime(substr($monthyear,2,4).'-'.substr($monthyear,0,2).'-20')),'ji_no','JI/'.$dept.'/W3/'.substr($monthyear,0,2).'/'.substr($monthyear,4,2),'X');
					$this->insert_model->jic_exist('Job_Items','Ceiling','Dept_Code',$dept,'Loc_Code',$row->V_location_code,'3','Month_Year',$monthyear,'Job_Date',date("Y-m-d",strtotime(substr($monthyear,2,4).'-'.substr($monthyear,0,2).'-20')),'ji_no','JI/'.$dept.'/W3/'.substr($monthyear,0,2).'/'.substr($monthyear,4,2),'X');
					$this->insert_model->jic_exist('Job_Items','Windows','Dept_Code',$dept,'Loc_Code',$row->V_location_code,'3','Month_Year',$monthyear,'Job_Date',date("Y-m-d",strtotime(substr($monthyear,2,4).'-'.substr($monthyear,0,2).'-20')),'ji_no','JI/'.$dept.'/W3/'.substr($monthyear,0,2).'/'.substr($monthyear,4,2),'X');
					$this->insert_model->jic_exist('Job_Items','Fixtures','Dept_Code',$dept,'Loc_Code',$row->V_location_code,'3','Month_Year',$monthyear,'Job_Date',date("Y-m-d",strtotime(substr($monthyear,2,4).'-'.substr($monthyear,0,2).'-20')),'ji_no','JI/'.$dept.'/W3/'.substr($monthyear,0,2).'/'.substr($monthyear,4,2),'X');
					$this->insert_model->jic_exist('Job_Items','Furniture Fitting','Dept_Code',$dept,'Loc_Code',$row->V_location_code,'3','Month_Year',$monthyear,'Job_Date',date("Y-m-d",strtotime(substr($monthyear,2,4).'-'.substr($monthyear,0,2).'-20')),'ji_no','JI/'.$dept.'/W3/'.substr($monthyear,0,2).'/'.substr($monthyear,4,2),'X');
				}
