							...
							<tr >
								<td class="ui-desk-style-table">
									<table class="ui-content-form" width="100%" border="0">
										<tr>
											<td class="td-assest" style="width:40%;">Vendor Namexx : </td>
											...
											<td><?php echo form_dropdown('n_vendor_name', $recordd, set_value('n_vendor_name',isset($record[0]->VENDOR_NAME) ? $record[0]->VENDOR_NAME : '') , 'class="dropdown" style="width: 52px;"'); ?></td>
											<input type="hidden" name="n_vendor_name2" id="n_vendor_name2" value="<?=$record[0]->VENDOR_NAME?>">
										</tr>
										<tr>
								...
								<?php $numberdate = 0; ?>
									<table class="ui-content-form" width="100%" border="0">
										...
										<tr>
											...
											<?php if ($this->input->get('tab') == 'Update'){ ?>
											...
											<?php }elseif($this->input->get('tab') == 'New'){ ?>
											<td><?php echo form_dropdown('n_vendor_name', $recordd, set_value('n_vendor_name',isset($record[0]->VENDOR_NAME) ? $record[0]->VENDOR_CODE : '') , 'class="form-control-button2 n_wi-date2" style="width: 292px;" onchange="this.form.submit()"'); ?></td>
											<?php } ?>
										</tr>
										<tr>
											<td class="td-assest">Vendor Code  :</td>
