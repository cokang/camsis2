		...
		<table class="tbl-wo" border="1" align="center" style="border: 1px solid black;">
			...
			<td style="width:50%; padding:1px;"><table class="tbl-wo-1" border="0" align="left">
						...
						<tr>
							...
							<td style="width:35%;">: <span style="color:blue;"><?= ($woinfo2[0]->V_requestor) ? $woinfo2[0]->V_requestor : 'NA' ?></span></td>
						...
						<td>
							<table class="tbl-wo" border="0" align="left">
								<tr height=3></tr>
									...
									<?php   if((strtotime($woinfo2[0]->V_Wrn_end_code) > strtotime(date("Y-m-d")))) {?>
					...
					<td valign="top" colspan="2">
						<table class="tbl-wo-2">
							<tr>
								...
								<td width="2.5%"> : </td>
								<td><span style="color:blue;"><?= ($woinfo2[0]->V_requestor) ? $woinfo2[0]->V_requestor : 'NA' ?></span></td>
							</tr>
							<tr>
								<td>Department</td>
								<td> : </td>
