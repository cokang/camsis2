				...
				<div class="middle_d2">
					...
					<table width="100%" class="ui-content-form-reg" style="background:white;">
						<tr class="ui-color-contents-style-1" height="30px">
							...
							<?php }elseif($this->input->get('tab') == 3){ ?><b>Payment One</b><span style="display:iniline-block; font-size:12px; color:red;"><?php  if (!($chk)){?> You may not update this section until you have filled in SHIPMENT / INVOICE & DO information<?php } ?></span>
							<?php }elseif($this->input->get('tab') == 4){ ?><b>Payment Two</b><span style="display:iniline-block; font-size:12px; color:red;"><?php  if (!($chk)){?> You may not update this section until you have filled in Payment One information<?php } ?></span>
							<?php }elseif($this->input->get('tab') == 5){ ?><b>Payment Three</b><span style="display:iniline-block; font-size:12px; color:red;"><?php  if (!($chk)){?> You may not update this section until you have filled in Payment Two information<?php } ?></span>
												...
												<td class="ui-desk-style-table">
													<table class="ui-content-form" width="100%" border="0">
														...
														<tr>
															...
															<td><?=isset($pofollow[0]->monthclosed) ? date("d-m-Y",strtotime($pofollow[0]->monthclosed)) : ''?></td>
														</tr>
														<tr>
