...
class Ajaxasisa2 extends CI_Controller {
...
//}
        ...
        $result =   $this->csvreader->parse_file('C:\inetpub\wwwroot\FEMSHospital_v32\application\controllers\Service_Work_(Unscheduled_&_Others)_09_Mar_2018.csv');
        ...
        $data['csvData'] =  $result;
				...
				foreach ($data['csvData'] as $value) {
					//$this->load->model('update_model');
			    //$this->get_model->ins_testdup($insert_data,TRUE);
			    $this->update_model->updateOnDuplicate('asisbah',$value);
				}
				//$this->load->model('update_model');
		    //$this->get_model->ins_testdup($insert_data,TRUE);
