...
set_time_limit(0);
class Ajaxasisa extends CI_Controller {
...
//}
        ...
        $result =   $this->csvreader->parse_file('C:\inetpub\wwwroot\FEMSHospital_v32\application\controllers\BEMS_Service_Request_02_Apr_2018.csv');
